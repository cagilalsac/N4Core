...
10. Built-in simple account management with users and roles, also supporting Identity Framework.
11. File explorer to browse text, image or other files under folders and view their contents (for text and image) or download them (for other).
12. Customized scaffolding for creating MVC and API controllers together, controller actions and MVC views using the same service and model.
13. Customized scaffolding for creating API controllers and actions using the same handler, request and response.
14. Built-in Application Settings management using appsettings.json file.
15. Built-in Google Gemini interaction.

# MVC Features:
16. Optional built-in paging, ordering and filtering structures for lists.
17. Built-in English and Turkish languages support.
18. Excel export support.
19. Bootstrap 5 Modal support.
20. Listing operations support by using a list or cards. 
21. Built-in Cookie Authentication.

# API Features:
22. Built-in JWT Authentication.
